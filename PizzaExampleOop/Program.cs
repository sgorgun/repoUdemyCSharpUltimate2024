using PizzaExampleOop.Extensions;
...
public class Panttone : Desert, IBakeable
{
    public string GetInstructions() => "Bake 180 degrees Celsius for 15 minutes";
}
...
public class Pizza : IBakeable
{
    ...
    public string GetInstructions() => "Bake 250 degrees Celsius for 20 minutes";
